"""
Memovich configuration system.

Priority: env vars > config file (~/.memovich/config.json) > defaults
"""
...
DEFAULT_PALACE_PATH = os.path.expanduser("~/.memovich/palace")
DEFAULT_COLLECTION_NAME = "memovich_chunks"
DEFAULT_VECTOR_BACKEND = "postgres"
DEFAULT_POSTGRES_DSN = "postgresql://localhost:5432/memovich"
DEFAULT_POSTGRES_TABLE = "memovich_chunks"
...
class MemovichConfig:
    """Configuration manager for Memovich.
    ...
    def __init__(self, config_dir=None):
        ...
        Args:
            config_dir: Override config directory (useful for testing).
                        Defaults to ~/.memovich.
        """
        self._config_dir = (
            Path(config_dir) if config_dir else Path(os.path.expanduser("~/.memovich"))
        )
    ...
    def palace_path(self):
        ...
        env_val = os.environ.get("MEMOVICH_PALACE_PATH")
        if env_val:
            return env_val
    ...
    def vector_backend(self) -> str:
        ...
        env = os.environ.get("MEMOVICH_VECTOR_BACKEND")
        if env:
    ...
    def postgres_dsn(self) -> str:
        env = os.environ.get("MEMOVICH_POSTGRES_DSN")
        if env:
            return env.strip()
