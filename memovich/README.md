# memovich/ — Core Package

The Python package that powers Memovich. All modules, all logic.
...
| `config.py` | Configuration loading — `~/.memovich/config.json`, env vars, defaults |
