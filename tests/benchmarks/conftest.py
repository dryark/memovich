...
def config_dir(tmp_path):
    """Isolated config directory for monkeypatching MemovichConfig."""
    d = tmp_path / "config"
    d.mkdir()
    config = {"palace_path": str(tmp_path / "palace"), "collection_name": "memovich_chunks"}
...
def pytest_terminal_summary(terminalreporter, config):
    ...
    results_file = os.path.join(tempfile.gettempdir(), "memovich_bench_results.json")
