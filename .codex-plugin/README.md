...
1. Clone the Memovich repository:

```bash
git clone https://github.com/milla-jovovich/memovich.git
cd memovich
```
...
- Repository: https://github.com/milla-jovovich/memovich
- Issues: https://github.com/milla-jovovich/memovich/issues
