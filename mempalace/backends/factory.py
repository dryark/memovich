...
def _backend_key(cfg: "MempalaceConfig") -> Tuple[Any, ...]:
    return (
        cfg.vector_backend,
        cfg.postgres_dsn or "",
...
def create_backend(cfg: "MempalaceConfig"):
    ...
    if kind == "postgres":
        ...
        try:
            ...
            raise ImportError(
                "vector_backend=chroma requires the chroma extra: pip install 'mempalace[chroma]'"
            ) from e
