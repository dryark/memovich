#!/bin/bash
# MEMOVICH PRE-COMPACT HOOK — Emergency save before compaction
#
...
#       "hooks": [{
#         "type": "command",
#         "command": "/absolute/path/to/memovich_precompact_hook.sh",
#         "timeout": 30
#       }]
#     }]
#   }
...
# Set MEMOVICH_DIR below if you want the hook to auto-ingest before compaction.
...
# Optional: run memovich ingest synchronously so memories land before compaction
